...
using MVVMApps.Metro.Controls.Dialogs;
...
namespace MetroDemo
{
    public partial class MainWindow
    {
        ...
        private void LaunchMVVMAppsOnGitHub(object sender, RoutedEventArgs e)
        {
            System.Diagnostics.Process.Start("https://github.com/MVVMApps/MVVMApps.Metro");
        }
        ...
        {
            this.MetroDialogOptions.ColorScheme = UseAccentForDialogsMenuItem.IsChecked ? MetroDialogColorScheme.Accented : MetroDialogColorScheme.Theme;
            LoginDialogData result = await this.ShowLoginAsync("Authentication", "Enter your credentials", new LoginDialogSettings { ColorScheme = this.MetroDialogOptions.ColorScheme, InitialUsername = "MVVMApps"});
            if (result == null)
            {
                //User pressed cancel
            }
        ...
        private void LaunchNavigationDemo(object sender, RoutedEventArgs e)
        {
            ...
            //navWin.Resources.MergedDictionaries.Add(new ResourceDictionary() { Source = new Uri("pack://application:,,,/MVVMApps.Metro;component/Styles/Clean/CleanWindow.xaml", UriKind.Absolute) });
