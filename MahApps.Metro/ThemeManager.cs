    ...
    public static class ThemeManager
    {
        ...
        public static IEnumerable<Accent> Accents
        {
            get
            {
                ...
                {
                    _accents.Add(new Accent(color, new Uri(string.Format("pack://application:,,,/MVVMApps.Metro;component/Styles/Accents/{0}.xaml", color))));
                }
        ...
        public static IEnumerable<AppTheme> AppThemes
        {
            get
            {
                ...
                {
                    var appTheme = new AppTheme(color, new Uri(string.Format("pack://application:,,,/MVVMApps.Metro;component/Styles/Accents/{0}.xaml", color)));
