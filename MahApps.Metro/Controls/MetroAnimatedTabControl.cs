...
namespace MVVMApps.Metro.Controls
{
    public class MetroAnimatedTabControl : TabControl
    {
        ...
        public static readonly DependencyProperty CloseTabCommandProperty =
            DependencyProperty.Register("CloseTabCommand", typeof(ICommand), typeof(MetroAnimatedTabControl), new PropertyMetadata(new MVVMApps.Metro.Controls.MetroTabControl.DefaultCloseTabCommand()));
    }
}
